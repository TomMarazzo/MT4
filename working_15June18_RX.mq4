   ...
   for(int i = 0;i<limit;i++)
     {
      ...
      //LONG
      if(currentEMALow34>currentEMA144 && previousEMALow34<previousEMA144)// && Bid>RoyalPointerUp)

        {
         upArrow[i]=currentEMALow34-0.001;
        }
      //SHORT
      else if(currentEMAHigh34<currentEMA169 && previousEMAHigh34>previousEMA169)// && Bid<RoyalPointerDn)
        {
