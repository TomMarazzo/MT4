...
void SetArrowUpObject()
  {
   ObjectCreate(0,upArrow,OBJ_ARROW_UP,0,0,0);
   ObjectSetInteger(0,"upArrow",OBJPROP_COLOR,clrBlue);
   ObjectSetInteger(0,"upArrow",OBJPROP_CORNER,1);
   ObjectSetInteger(0,"upArrow",OBJPROP_XDISTANCE,21);
   ObjectSetInteger(0,"upArrow",OBJPROP_YDISTANCE,41);
  }
void SetArrowDnObject()
  {
   ObjectCreate(0,"dnArrow",OBJ_ARROW_DOWN,0,0,0);
   ObjectSetInteger(0,"dnArrow",OBJPROP_COLOR,clrRed);
   ObjectSetInteger(0,"dnArrow",OBJPROP_CORNER,1);
   ObjectSetInteger(0,"dnArrow",OBJPROP_XDISTANCE,21);
   ObjectSetInteger(0,"dnArrow",OBJPROP_YDISTANCE,41);
